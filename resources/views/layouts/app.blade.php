            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    @if(isset($settings['logo']))
                        ...
                        {{-- <img src="{{ config('app.url') . 'storage/' . $settings['logo'] }}" alt="logo image"> --}}
                ...
                <div class="right-header">
                    <div class="header-info">
                        <div class="info-inner">
                            <span class="icontop">
                                {{-- <img src="{{ config('app.url') }}images/phone-icon.png" alt="#"> --}}
                                <img src="{{ asset('images/phone-icon.png')}}" alt="#">
                            </span>
                            <span class="iconcont"><a
                                    href="tel:{{ $settings["phone"] ?? '+972 6778833' }}">{{ $settings["phone"] ?? '+972 6778833' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                            <span class="iconcont">
                                <a data-scroll
                                    href="mailto:{{ $settings["email"] ?? 'Fouad@test.com' }}">{{ $settings["email"] ?? 'Fouad@test.com' }}</a>
                ...
                <div class="col-md-4">
                    <div class="logo padding">
                        <a href="{{ url('/') }}">
                            ...
                            <img src="{{ 'storage/'.$settings["logo"] ??  config("app.url").'images/logo.png' }}"
                                alt="">
                                @else
                                <span>No Logo Available</span>
                            @endif
